...
export default class Root extends Component {
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                >
                    {this._renderContent("PersonalCenter")}
                </TabNavigator.Item>
    ...
    _renderContent(moduleName) {
        let view = <Index/>;
        const nas=this.props;
        switch (moduleName) {
            case 'index':
                view = <Index
                    click={Util.pressSkip.bind(this,this,"articleDetail",{name:"Tomert"})}
                    searchClick={Util.pressSkip.bind(this,this,"search")}/>;
                break;
            case 'PersonalCenter':
                view = <PersonalCenter click={Util.pressSkip.bind(this,this,"login")}/>;
                break;
            default :
                view = <Index/>;
                break;
